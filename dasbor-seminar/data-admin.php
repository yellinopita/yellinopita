...
<head>
    ...
    <!-- Title Page-->
    <title>Data Seminar Wirausaha - <?=$_SESSION['username'];?></title>
...
<body class="animsition">
    <div class="page-wrapper">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    ...
                                    <a class="au-btn au-btn-icon au-btn--blue" href="tambah-admin/">
      ...
      <a href="edit-admin/index.php?id_user=<?php echo $data['id_user']; ?>&aksi=edit" type="button" class="btn btn-primary"><i class="fa fa-edit"></i></a>
